...
class Settings:
    ...
    def __init__(
        ...
        html_template_file="desktop.html",
        css_folder=default_static_folder,
    ...
    def __eq__(self, other):
        return (
            (
                ...
                self.html_template_folder,
                self.html_template_file,
                self.css_folder,
                self.css_file,
                self.on_top,
                self.width,
            ...
            == (
                ...
                other.hostname,
                other.port,
                other.split_separator,
                other.previous_splits,
                other.next_splits,
                other.font_size,
                other.font_color,
                other.background_color,
                other.html_template_folder,
                other.html_template_file,
                other.css_folder,
                other.css_file,
                other.on_top,
                other.width,
