# Modified from:
# https://raw.githubusercontent.com/python/cpython/v3.11.0/Lib/test/test_dataclasses.py
...
class TestCase(unittest.TestCase):
    ...
    @api_difference("Different error type and error message")
    ...
    @api_difference("prefab attributes do not support a 'name' field")
    ...
    @api_difference("prefab_classes raises a syntax error as do regular python classes")
    ...
    @api_difference("prefab_classes will not protect you if you call a field self.")
    ...
    @api_difference("Prefab classes do not support automatic generation of ordering")
    ...
    @api_difference("prefabs delete the class attributes after creation.")
    ...
    @api_difference("prefab_classes does not protect you from using mutable defaults")
    ...
    @api_difference("prefabs won't allow you to skip init and not provide a default")
    ...
    @api_difference("prefabs attributes do not know their names")
    ...
    @api_difference("prefab classes remove class attributes once defined.")
    ...
    @api_difference("Prefab classes allow mutable defaults for better or worse")
    ...
    @api_difference("_NOTHING doesn't have a good REPR")
    def test_missing_repr(self):
        self.assertIn('MISSING_TYPE object', repr(MISSING))

    @api_difference("annotations are removed once used.")
    ...
    @api_difference("prefab_classes will only have 4 annotations as x and y will be deleted.")
    ...
    @api_difference("If you use a classvar, prefab_classes ignores it completely.")
    ...
    @api_difference("If you use a classvar, prefab_classes ignores it completely. "
                    "The field will not be evaluated.")
    ...
    @api_difference("prefab_classes will not support InitVar")
    ...
    @api_difference("Different error message when as_dict called on non-prefab")
    ...
    @api_difference("'fields' function does not exist in prefabs, "
                    "only in these tests as a compatibility assistant")
    ...
    @api_difference("Different error message")
    ...
    @api_difference("prefab_classes as_dict does not recurse")
...
class TestSlots(unittest.TestCase):
    ...
    # FROZEN IS NOT IMPLEMENTED - THIS FAILS THE IMPORT
